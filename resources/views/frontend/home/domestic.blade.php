<form action="{{ route('search.flight') }}" method="POST">
    ...
    <div class="absolute top-4 left-[300px]">
        <div class="relative">
            <select name="type" id="domesticTripType" class="border-0 py-3 text-sm font-medium rounded-md focus:ring-0">
    ...
    <div class="mt-3">
        <div
            ...
            <div class="depcity_col_domestic flex border-e">
                <div class="hs-dropdown relative inline-flex [--auto-close:inside] w-full">
                    <div class="innercol hs-dropdwon-toggle" aria-haspopup="menu" aria-expanded="false"
                        ...
                        <input type="hidden" id="depairport-domestic" value="[KTM]" /> --}}
                        <input type="hidden" id="depairport-domestic-value" name="from" value="KTM" />
                        <div class="text-2xl font-semibold" id="d-domestic-depcity">Kathmandu</div>
                        <div class="font-medium text-xs" id="d-domestic-depairport">[KTM]</div>
                    </div>
                    <div class="px-4 py-3 z-50 hs-dropdown-menu search-d-transform duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-72 bg-white shadow-md rounded-lg mt-2 top-0"
                        ...
                        <div id="dropdownList" class="dropdown-content max-h-60 overflow-y-auto">
                            @foreach ($sectors->Sector as $sector)
                                <a sectorCode="{{ $sector->SectorCode }}" sectorName="{{ $sector->SectorName }}"
                                    class="sector_click block w-full px-4 py-2 pr-10 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 hover:border-blue-400"
                                    href="javascript:void(0)">{{ $sector->SectorName }} ({{ $sector->SectorCode }})</a>
                            @endforeach
                        </div>
                    </div>
                </div>
            ...
            <div class="arrcity_col_domestic flex border-e">
                <div class="hs-dropdown relative inline-flex [--auto-close:inside] w-full">
                    <div class="innercol hs-dropdwon-toggle" aria-haspopup="menu" aria-expanded="false"
                        aria-label="Dropdown" id="domestic-departure-drop">
                        ...
                        <input type="hidden" id="arrairport-domestic-value" name="to" value="PKR" />
                        <div class="text-2xl font-semibold" id="d-domestic-arrcity">POKHARA</div>
                        <div class="font-medium text-xs" id="d-domestic-arrairport">[PKR]</div>
                    </div>
                  ...
                  >
                    <i class="fa-solid fa-xmark"></i>
                        ...
                        <div id="dropdownList" class="dropdown-content">
                            @foreach ($sectors->Sector as $sector)
                                <a sectorCode="{{ $sector->SectorCode }}" sectorName="{{ $sector->SectorName }}"
                                    class="sector2_click block w-full px-4 py-2 pr-10 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 hover:border-blue-400"
                                    href="javascript:void(0)">{{ $sector->SectorName }} ({{ $sector->SectorCode }})</a>
                            @endforeach
                        </div>
                    </div>
            ...
            <div class="flex border-e depdate_col">
                ...
                <span class="text-sm font-medium">Oct'2024</span> -->
                    <div class="flex items-center">
                        <input type="text" id="depdate-domestic" name="flightDate"
                        ...
                        <img class="w-[17px] h-[17px] float-right mt-[8px]" src="/public/images/icons/calendar.svg"
                            alt="" />
                    </div>
            ...
            <div class="flex border-e depdate_col ret-date-col-domestic" style="opacity: 0.4">
                <div class="innercol relative">
                    ...
                    <div class="flex items-center">
                        <input type="text" id="returndate-domestic" name="returnDate"
                            class="peer px-0 block w-full bg-transparent border-0 text-base text-black font-semibold disabled:opacity-50 disabled:pointer-events-none tracking-wide focus:shadow-none focus:ring-0"
                            placeholder="mm/dd/yyyy" />
                        <img class="w-[17px] h-[17px] float-right mt-[8px]" src="/public/images/icons/calendar.svg"
                            alt="" />
    ...
    "extraMarkup": "<div class=\"absolute top-1/2 end-3 -translate-y-1/2\"><svg class=\"shrink-0 size-3.5 text-gray-500 \" xmlns=\"http://www.w3.org/2000/svg\" width=\"24\" height=\"24\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"m7 15 5 5 5-5\"/><path d=\"m7 9 5-5 5 5\"/></svg></div>"
            ...
            <div class="search-col">
                <button type="submit" class="btn_search bg-secondary py-10 w-full text-xl text-white font-semibold">
                    SEARCH
                </button>
            </div>
        </div>
...
<script>
    ...
    $(document).on('click', '.sector_click', function(e) {
        ...
        $('#d-domestic-depcity').text(sname);
        $('#d-domestic-depairport').text(`[${scode}]`);
    })
