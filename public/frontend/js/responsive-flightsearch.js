...
function displayInputValues() {
  const depAirport = document.getElementById("r-depairport").value;
  const depCity = document.getElementById("r-depcity").value;
  const arrAirport = document.getElementById("r-arrairport").value;
  const arrCity = document.getElementById("r-arrcity").value;

  document.getElementById("display-depairport").textContent = depAirport;
  document.getElementById("display-depcity").textContent = depCity;
  document.getElementById("display-arrairport").textContent = arrAirport;
  document.getElementById("display-arrcity").textContent = arrCity;
}
